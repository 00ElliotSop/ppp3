        ...
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex items-center justify-center text-center text-white z-10 px-2">
            <div className="w-full max-w-4xl px-2">
              ...
              <Link
                to="/book-now"
                className="bg-[#B5A99A] text-white px-4 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 rounded-full font-semibold hover:bg-[#F7E7CE] hover:text-white transition-all duration-300 inline-block"
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <Link
                to="/about-us"
                className="bg-[#B5A99A] text-white px-4 sm:px-6 md:px-8 py-2 sm:py-3 rounded-full hover:bg-[#F7E7CE] hover:text-white transition-all duration-300 inline-block font-semibold"
