...
const AboutUs = () => {
  const teamMembers = [
    ...
    },
    {
      name: "Vick L",
      image: "/Vic.JPG", 
      quote: "CHIEF OPERATIONS OFFICER & PHOTOBOOTH OPERATOR - MEASURE TWICE, AND CUT ONCE.",
    ...
    },
    {
      name: "Prince A",
      image: "/Prince.JPG",
      quote: "CHIEF TECHNOLOGY OFFICER & PHOTOBOOTH OPERATOR - INNOVATION WITH PERCISION, EXECUTION WITH PURPOSE.",
    ...
    },
    {
      name: "Matthew L",
      image: "/Matthew.JPG",
      quote: "PHOTOBOOTH OPERATOR - NEVER JUDEGE A PERSON BY THEIR WORSE ACTIONS.",
