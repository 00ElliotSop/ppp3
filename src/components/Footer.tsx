        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/other-rentals" className="text-gray-300 hover:text-[#F7E7CE] transition-colors">Other Rentals</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <Phone size={16} />
                <span className="text-gray-300">416-616-1121</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail size={16} />
      ...
      <div className="border-t border-gray-800 py-6">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <p className="text-gray-400 text-sm text-center md:text-left">
            © 2024 Project Party Productions. Developed and Designed by ElliotSop.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-gray-400 hover:text-[#F7E7CE] text-sm transition-colors">Privacy Policy</a>
            <a href="#" className="text-gray-400 hover:text-[#F7E7CE] text-sm transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
